...
tags: [ai, interviews, career, agentic-ai, skills]
---

If you're attending technical interviews for product companies, here's something you need to know: going forward, you'll be expected to work with AI tools during the interview.
...
- Explore knowledge bases and artifacts
- Understand the tool's capabilities
- Structure your approach accordingly

## What Interviewers Are Looking For

It's not about whether you can build a Todo app or a trivia game just by prompting the UI.
...
In the old way, a developer would sit with you, brainstorm the problem, and observe how you think through requirements, modularity, and code structure.
